...
const COPY = {
  ru: {
    ...
    openPersistentProfile: "Открыть профиль и документы компании", companyProfileToggleEyebrow: "Данные компании",
    companyProfileToggleTitle: "Реквизиты и документы компании",
    companyProfileToggleHint: "Заполните юридические данные, сайт, лицензию и загрузите документы для проверки.",
    companyProfileToggleAction: "Открыть раздел", brandName: "Название бренда", legalName: "Юридическое название",
  ...
  en: {
    ...
    openPersistentProfile: "Open company profile and documents", companyProfileToggleEyebrow: "Company details",
    companyProfileToggleTitle: "Company information and documents",
    companyProfileToggleHint: "Add legal details, website and licence information, then upload documents for review.",
    companyProfileToggleAction: "Open section", brandName: "Brand name", legalName: "Legal name",

  ...
  return <>
    ...
    <Panel className="mb-6">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
        ...
        <span className="rounded-lg bg-gray-50 px-3 py-2 text-xs text-gray-500 dark:bg-white/[0.03]">{googleData ? `Финальные данные по ${shortDate(googleData.data_through)} · API проверен ${dateTime(googleData.fetched_at)}` : googleLoading ? "Загрузка…" : "Нет данных"}</span>
      </div>

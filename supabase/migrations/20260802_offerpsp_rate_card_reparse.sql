alter table private.offerpsp_rate_card_batches
  drop constraint if exists offerpsp_rate_card_batches_provider_id_source_hash_key;

alter table private.offerpsp_rate_card_batches
  add constraint offerpsp_rate_card_batches_provider_source_parser_key
...
comment on constraint offerpsp_rate_card_batches_provider_source_parser_key
on private.offerpsp_rate_card_batches is
  'The same immutable partner message may be normalized again by a newer parser version.';

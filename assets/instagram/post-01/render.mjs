...
const slides = [
  {
    eyebrow: "PRIVATE PSP MATCHING",
    headlineSize: 88,
    headline: ["Finding a PSP", "is not a", "directory search."],
    body: ["Fit depends on the merchant profile —", "not on a logo list."],
  },
  {
    eyebrow: "THE OPERATING CONTEXT MATTERS",
    headlineSize: 76,
    headline: ["The same route", "does not fit", "every merchant."],
    body: ["GEO · LICENCE · VERTICAL · RISK"],
  },
  {
    eyebrow: "STEP 01 · QUALIFY",
    headlineSize: 82,
    headline: ["OfferPSP structures", "the merchant brief."],
    body: ["Entity · Methods · Currencies", "Volume · Settlement"],
  },
  {
    eyebrow: "STEP 02 · MATCH",
    headlineSize: 74,
    headline: ["We compare", "relevant payment", "routes."],
    body: ["Fit comes before introductions."],
  },
  {
    eyebrow: "STEP 03 · PROVIDER REVIEW",
    headlineSize: 80,
    headline: ["The provider makes", "the final decision."],
    body: ["No responsible intermediary", "can guarantee approval."],
  },
  {
    eyebrow: "THE OfferPSP DIRECTION",
    headlineSize: 70,
    headline: ["Private matching now.", "Broader transparency", "as verified supply grows."],
    body: ["Built around available route information", "and qualified introductions."],
  },
];
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}" role="img" aria-labelledby="title desc">
  <title id="title">OfferPSP carousel slide ${index + 1}</title>
  ...
  <text x="126" y="1272" fill="#dfe2ea" font-family="Arial, Helvetica, sans-serif" font-size="30" font-weight="700">Private payment-provider matching</text>
...
const previewGap = 24;
const previewWidth = previewTileWidth * 3 + previewGap * 4;
const previewHeight = previewTileHeight * 2 + previewGap * 3;
...
console.log(`Rendered ${slides.length} OfferPSP carousel slides to ${outputDirectory}`);
